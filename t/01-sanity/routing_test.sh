...
# 3. Add static route
ip route add 192.168.100.0/24 dev dummy0 2>/dev/null
ok $? "Can add static route via interface"
...
ip route del 192.168.100.0/24 dev dummy0 2>/dev/null
ok $? "Can delete static route"
