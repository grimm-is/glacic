  ...
  <div class="auth-view">
    <div class="auth-container">
      <div class="auth-header">
        ...
        <h1 class="auth-title">Welcome to {$brand?.name}</h1>
    ...
    <aside class="sidebar" class:open={sidebarOpen}>
      ...
      <nav class="sidebar-nav">
        ...
        <a
          href="#topology"
          class="nav-item"
          class:active={$currentPage === "topology"}
        >
          Topology
        </a>
        <a
    ...
    <div class="main-wrapper">
      <header class="header">
        ...
        <div class="header-actions">
          <span class="status-indicator" class:online={$config?.ip_forwarding}>
            {$config?.ip_forwarding ? "Online" : "Offline"}
          </span>
