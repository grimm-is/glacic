    ...
    connectStatusWS() {
        ...
        ws.onopen = () => {
            ...
            ws.send(JSON.stringify({
                action: 'subscribe',
                topics: ['status', 'config', 'leases', 'notification']
            }));
        };
...
export const consoleModules = [
    ...
    { id: 'ipsets', label: 'Blocklists', category: 'Shield', icon: 'ListFilter' },
    ...
    // System
    { id: 'logging', label: 'Logs', category: 'System', icon: 'ScrollText' },
